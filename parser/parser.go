...
import (
	...
	"github.com/laracarvalho/ino-lang/ast"
	"github.com/laracarvalho/ino-lang/lexer"
	"github.com/laracarvalho/ino-lang/token"
)

// Order of lower to higher precedence of operators
const (
	_ int = iota
	LOWEST
	EQUALS      // ==
...
func New(l *lexer.Lexer) *Parser {
	...
	// We read two times so current and next are set
	p.nextToken()
	p.nextToken()
